...
function addItems(){
  ...
  createItem(110, 200, 'poison');
  createItem(425, 400, 'poison');
  createItem(700, 250, 'poison');
    createItem  (20, 500, 'poison');
...
function addPlatforms() {
  ...
  platforms.create(48, 400, 'platform2');
...
window.onload = function () {
  ...
  function preload() {
    game.stage.backgroundColor = '#5F9EA0';
